const actionTypes = Object.freeze({
    ...
    FETCH_TOP_CENTERS_SUCCESS: 'FETCH_TOP_CENTERS_SUCCESS',
    FETCH_TOP_CENTERS_FAILED: 'FETCH_TOP_CENTERS_FAILED',

    FETCH_ALL_CENTERS_SUCCESS: 'FETCH_ALL_CENTERS_SUCCESS',
    FETCH_ALL_CENTERS_FAILED: 'FETCH_ALL_CENTERS_FAILED',

    SAVE_DETAIL_CENTER_SUCCESS: 'SAVE_DETAIL_CENTER_SUCCESS',
    SAVE_DETAIL_CENTER_FAILED: 'SAVE_DETAIL_CENTER_FAILED',
