...
import { getScheduleCenterByDate } from '../../../services/userService';
                ...
                <div className='center-schedule-container'>
                    ...
                    <div className='all-available-time'>
                        <div className='text-calendar'>
                            ...
                            <span><FormattedMessage id="own.detail-center.schedule" /></span>
                        </div>
                            ...
                            {allAvalableTime && allAvalableTime.length > 0 ?
                                <>
                                    ...
                                    <div className="book-free">
                                        <span>
                                            <FormattedMessage id="own.detail-center.choose" />
                                            <i className="far fa-hand-point-up"></i>
                                            <FormattedMessage id="own.detail-center.book-free" />
                                        </span>
                                    </div>
                                </>
                                :
                                <div className="no-schedule">
                                    <FormattedMessage id="own.detail-center.no-schedule" />
                                </div>
                            }
                        </div>
                    </div>
...
export default withRouter(
    connect(mapStateToProps, mapDispatchToProps)(CenterSchedule)
);
